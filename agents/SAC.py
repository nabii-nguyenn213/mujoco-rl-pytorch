...
class SAC_Agent: 
    def __init__(self, config): 
        ...
        self.net = ActorDoubleQCriticNetwork(obs_dim, act_dim, action_lim, hidden_size_actor, hidden_size_critic).to(self.device) 
        # Target critic 
    ...
    def update(self, batch): 
        ...
        with torch.no_grad(): 
            ...
            target         = rew + self.gamma * (1.0 - done) * (target_q_next - self.alpha * next_log_pi) 
